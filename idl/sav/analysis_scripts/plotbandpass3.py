...
PLOTBANDPASS_REVISION_STRING = "$Id: plotbandpass3.py,v 1.211 2021/04/23 12:48:05 thunter Exp $" 
import pylab as pb
...
def version(showfile=True):
    ...
    """
    myversion = "$Id: plotbandpass3.py,v 1.211 2021/04/23 12:48:05 thunter Exp $" 
    if (showfile):
