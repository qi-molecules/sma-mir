function gain_xpol1,gai_souids,gai_fluxes_3mm,gai_fluxes_1mm,tel_bsl, $
...
result=dat_list(s_l,souid_str+'and (("ipol" eq "1")) and "iband" eq "0" and "wt" gt "0"',/reset)
...
result=dat_list(s_l,souid_str+' and (("ipol" eq "1")) and "band" like "c" and "wt" gt "0"', /no_notify, /reset)
