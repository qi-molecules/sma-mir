...
function plot_cobra_int,at_ovro,noreset=noreset,plotpdf=plotpdf,pdfonly=pdfonly
   ...
   ; Plot data
     ...
     for j=j1,j2 do begin
        ...
        ; Make plot
          result = wlm_plot_data(xdata,y,replicate(1,n_elements(ydata)),$
...
function reduce_cobra,noreset=noreset,plotpdf=plotpdf,pdfonly=pdfonly,$
   ...
   ; Plot data
     if not keyword_set(noplots) then begin
        ...
        result = plot_cobra_int(at_ovro,noreset=noreset,plotpdf=plotpdf,pdfonly=pdfonly)
     endif
