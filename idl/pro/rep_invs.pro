function rep_invs,report,fn=fn,list=list,nline=nline
;
; generates a report with summary information on invsetigators 
;
...
;
; eg. res=rep_invs()
; eg. res=rep_invs(report,fn='rpt',/list,nline=1000)
; eg. res=rep_invs(report,/list,nline=1000)
;
;
common global
...
sql='select inv#,init,lname+", "+fname,email' + $
    '  from mmdb..INV d order by lname asc '
dbi_sql_tab,sql,ct_res,db_tab,fmt_n,widths_n,tab_c,fmt_c,widths_c,com_row
;
; db_tab has a list of the inv#, init, lname, fname and email 
;
