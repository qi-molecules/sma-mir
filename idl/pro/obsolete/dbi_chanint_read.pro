function dbi_chanint_read,in_skip=in_skip, in_rows=in_rows
; 
...
if not keyword_set(in_skip) then in_skip=0
...
if keyword_set(in_rows) then nints_expected=in_rows else nints_expected = long(n_elements(in))
