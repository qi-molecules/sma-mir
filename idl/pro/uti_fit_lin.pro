pro uti_fit_lin,xx,yy,a,siga,b,sigb
;+
; NAME:
;       UTI_FIT_LIN (taken directly from sixlin.pro)
; PURPOSE:
...
;
; CALLING SEQUENCE:
;       UTI_FIT_LIN, xx, yy, a, siga, b, sigb   
;
; INPUTS:
...
;-
 ...
 if N_params() LT 5 then begin   
    print,'Syntax - UTI_FIT_LIN, xx, yy, a, siga, b, sigb   
    return
  endif
...
; Compute averages and sums
 ...
 syy = total(y^2)
 sxy = total(x*y)
 if sxy EQ 0. then begin
      printf,-1,'WARNING: SXY is zero, UTI_FIT_LIN is terminated'
      return
 endif
